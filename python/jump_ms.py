...
left_foot_forces_1 = dict()
left_foot_forces_2 = dict()
for frame in left_foot_frames:
    left_foot_forces_1[frame] = prb.createInputVariable("f_" + frame + "_1", 3)
    left_foot_forces_2[frame] = prb.createInputVariable("f_" + frame + "_2", 3)

right_foot_forces_1 = dict()
right_foot_forces_2 = dict()
for frame in right_foot_frames:
    right_foot_forces_1[frame] = prb.createInputVariable("f_" + frame + "_1", 3)
    right_foot_forces_2[frame] = prb.createInputVariable("f_" + frame + "_2", 3)

foot_forces = dict()
foot_forces.update(left_foot_forces_1)
foot_forces.update(left_foot_forces_2)
foot_forces.update(right_foot_forces_1)
foot_forces.update(right_foot_forces_2)
...
x_1 = F_integrator(x=x_prev, u=qddot_prev, dt=dt_prev)
x_int = F_integrator(x=x_1, u=qddot_prev, dt=dt_prev)
prb.setDt(dt)
...
tau_lim[0:6] = 0.0
# print(tau_lim)
# Calculate tau from inverse dynamics
